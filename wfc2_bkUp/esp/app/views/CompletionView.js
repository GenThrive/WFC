  ...
  var CompletionView = Marionette.ItemView.extend({
    ...
    getRating: function() {
      ...
      if (userLang === "ESP") {
          ...
          if (scoreBase > 1401 && scoreBase <= 2400) {
            rating  = "Average - Your footprint is about average. There's room to improve, so find how to lower it below.";
          }
          if (scoreBase > 2400) {
    ...
    twitter: function(evt) {
      evt.preventDefault();
      var msg = "1,870 gal/día. ¡Esa es la huella hídrica promedio de alguien en los EE. UU! El mío es " + e.reqres.request('score:current:formatted') + " gal/día. Encuentre el suyo en calculadoradeagua.org";
