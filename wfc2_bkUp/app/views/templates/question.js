...
function program5(depth0,data) {
  ...
  buffer += "\n  <div id=\"question-help\">\n    <span class=\"help-toggle question-help-icon\"></span>\n    <span class=\"help-toggle question-close-icon icon icon-cross\"></span>\n    <p>"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.question)),stack1 == null || stack1 === false ? stack1 : stack1.help)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</p>\n  </div>\n";
  return buffer;
  }
  ...
  stack2 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.question)),stack1 == null || stack1 === false ? stack1 : stack1.help), {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
