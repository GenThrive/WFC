...
function program3(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n\n      ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.isComplete), {hash:{},inverse:self.program(6, program6, data),fn:self.program(4, program4, data),data:data});
