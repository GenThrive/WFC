...
// Jupiter makes filesystem changes on the frontend as well as the admin
// Always set the filesystem method to direct, not just within is_admin from the wp-config
