...
class MDD_Reference_Handler {
	...
	public function get_post_fields( $post ) {
		...
		// WooCommerce product variations don't "support" thumbnails, but they have them anyway (thanks,
		// WooCommerce), so look for thumbnails for those too.
		if ( post_type_supports( $post->post_type, 'thumbnail' ) || 'product_variation' === $post->post_type ) {
	...
	public function get_post_types() {
		...
		// Add WooCommerce product variations. These aren't a 'public' post type, but their product
		// images need to be replaced during Smart Delete.
