...
class Media_Deduper_Pro {
	...
	/**
	 * Declare some temporary query args to be 'removable'.
	 *
	 * This causes users who visit e.g. upload.php?page=media-deduper&smartdeleted=1,0 (which is where
	 * you're sent after 'smart-deleting' images) to only see upload.phpp?page=media-deduper in their
	 * URL bar.
	 *
	 * @param array $args An array of removable query args.
	 */
	public function removable_query_args( $args ) {
		// Arg added to MDD page URL after smart deletion:
		$args[] = 'smartdeleted';
		// Arg added to settings page URL after clicking 'Check again' in MDD's warning about password
		// protection and WP cron:
		$args[] = 'mdd_cbur_nonce';
		return $args;
	}
